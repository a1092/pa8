...
class TaskController extends Controller
{
    ...
    public function calendarAction()
    {
        ...
        $entities = $em->getRepository('SfTodoBundle:Task')->findBy(array('foyer' => $foyers[$user->getCurrentFoyer()]), array('deadline' => 'asc'));
    ...
    */
    private function createCreateForm(Task $entity)
    {
        $user = $this->container->get('security.context')->getToken()->getUser();
        $foyers = $user->getFoyers();
        $form = $this->createForm(new TaskType($foyers[$user->getCurrentFoyer()]), $entity, array(
